<template>
    <div class="home">
        ...
        <swiper :options="swiperOption" ref="mySwiper">
            <!-- slides -->
            <swiper-slide v-for="v in slider" :key="v.id">
                <img :src="v.path" alt="">
            </swiper-slide>
            <!-- Optional controls -->
...
<script>
    export default {
        ...
        mounted(){
            //r热门视频
            this.axios.get('http://zsv.wangyehe.com/api/hotLesson/4').then((response) => {
                this.hotLesson = response.data.data;
            })
            //推荐视频
            this.axios.get('http://zsv.wangyehe.com/api/commendLesson/3').then((response) => {
