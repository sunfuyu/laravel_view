    ...
    <div class="video">
        ...
        <ul id="videolist">
            <li v-for="v in lesson" :key="v.id">
                ...
                <router-link to="/page" class="title">{{v.title}}</router-link>
            </li>
...
<script>
    export default {
        ...
        mounted(){
            //r标签
            this.axios.get('http://zsv.wangyehe.com/api/tags').then((response) => {
        ...
        methods:{
            ...
            loadLesson(){
                ...
                this.axios.get('http://zsv.wangyehe.com/api/lesson/'+(tid?tid:0)).then((response) => {
                    //console.log(response.data)
